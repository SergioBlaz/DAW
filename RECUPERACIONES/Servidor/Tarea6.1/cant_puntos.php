<?php
function getJugadoresPuntos(){
    $base = mysqli_connect("localhost","root","","baloncesto");
    if($base){
        $sql = "SELECT nombre, posicion, partidos, puntos, rebotes, asistencias FROM jugadores ORDER BY puntos DESC";
